...
public class RequestResponseLogger {
	...
	@AfterReturning("execution(* com.eka.physicalstrade.controller..* (..))")
	...
	@AfterReturning(value = "execution(* com.eka.physicalstrade.controller..* (..))", returning = "result")
	...
	@AfterThrowing(value = "execution(* com.eka.physicalstrade.controller..* (..))", throwing = "e")
	public void afterThrowing(JoinPoint joinPoint, Throwable e) {
		if(RequestContextHolder.getCurrentContext()!=null)
		logUserRequest(RequestContextHolder.getCurrentContext().getRequest());
